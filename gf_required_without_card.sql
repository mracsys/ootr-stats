...
SELECT *
  FROM [OotrStatsCard].[dbo].[ispheres] as [csphere]
  LEFT JOIN [OotrStatsCard].[dbo].[ispheres] as [fsphere] ON ([csphere].[seed] = [fsphere].[seed] AND [csphere].[item] = 'Gerudo Membership Card' AND 
